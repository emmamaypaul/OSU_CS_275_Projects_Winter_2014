...
$mysqli = new mysqli("oniddb.cws.oregonstate.edu","pauli-db","XXXXXXXXXXX","pauli-db"); //Connects to the database
...
<html>
<head>
<title> Timberline Info Page - Final Project CS 275 </title>
<meta charset="UTF-8"/>
...
<div>
<form method="POST" action="http://web.engr.oregonstate.edu/~paule/CS%20275/timberlineResults.php">
	<fieldset>
